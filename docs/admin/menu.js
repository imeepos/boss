...
(function () {
  ...
  var groups = [
    { id: 'overview', label: '运营总览', ico: '▦', items: [
      { key: 'dashboard', label: '工作台', href: 'dashboard.html' },
    ]},
    { id: 'base', label: '基础配置', ico: '⚙', items: [
    ...
    { id: 'provision', label: '配置下发', ico: '📤', items: [
    ...
    { id: 'alarm', label: '告警中心', ico: '🔔', items: [
      { key: 'alarm',    label: '告警列表', href: 'alarm.html' },
    ]},
    { id: 'aaa', label: '认证计费', ico: '🛰', items: [
      { key: 'aaalog',   label: '话单与认证日志', href: 'aaalog.html' },
    ]},
    { id: 'intel', label: '数字孪生与经营', ico: '📊', items: [
