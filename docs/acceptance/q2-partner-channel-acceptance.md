...
- 已完成 102 `admin/admin123` 登录、Dashboard API、`/partner/home` 路由可达性验收；尚未使用真实 `partner_admin` 账号完成 `/partner/home`、`/partner/staff`、`/partner/orders` 的企业 API 数据验收，需要安全的伙伴账号/一次性凭证后继续。
