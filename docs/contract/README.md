...
| `alignment-audit.md` | 数据建模(首版快照 68 表，现役口径见 data-relations)↔ 三端页面 ↔ OpenAPI 销项台账(D/A/B/E/G# 编号) | 漂移缺口追溯、销项审计 |
| `data-relations.md` | 净口径 191 张业务表的数据从属关系总览(实体↔表↔迁移号↔ER 图；2026-09-05 机械对账) | 关系拓扑漂移、ER 图规格陈旧、表数口径不一 |
| `data-layers.md` | 数据分层依赖模型(L0 集团共享→L1 主档→L2 流程→L3 派生)+ mock 时期 33 处矛盾附录 | 层序误用、L1→L2 漏快照、附录 A 修复口径追溯 |
