...
| 文件 | 位置 | 现表述 | 应改为 | 状态 |
|:-----|:-----|:-------|:-------|:----:|
| 需求提示词-服务端.md | 六、标题及 199-209 行 | 11 个业务环节（无"合同收费"） | 12 环节，插入"4 合同收费" | ✅ 已改 |
| 需求提示词-服务端-9阶段拆分.md | 「附：11 个业务环节」整表 | 11 行环节表 | 12 行，插入"合同收费" | ✅ 已改 |
| README.md | 阶段5 描述 | "订单 11 环节" | "订单 12 环节" | ✅ 已改 |
| 技术栈方案-一步到位.md | 多处 | "订单 11 环节状态机" | "订单 12 环节状态机" | ✅ 已改 |
