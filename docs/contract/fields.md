...
| 预缴月数 | `BuyMonths` | buy_months | 0~60（000103）；0=按月缴（环节 4 收 1 个月月费），N>0=预缴 N 月（环节 4 收 N×月费，区域覆盖口径同出账） |
| 赠送月数 | `GiftMonths` | gift_months | 0~60（000103）；环节 4 收款时按 gift_duration_rules 阶梯命中回填（如 6送1/12送3/24送6，取 ≤预缴月数的最大档），未命中为 0 |
