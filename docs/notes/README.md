...
| 2026-09-08 | 前端体验打磨立项:选择器专项 Wave0 优先(只动 components/pickers 对外加法),页面按域逐页打磨并顺手采用现成组件,合并权收归负责人串行执行;独立机械替换批次先行被否决 | adopted/2026-09-08-ux-polish-component-adoption.md |
