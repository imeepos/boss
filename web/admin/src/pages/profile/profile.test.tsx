  ...
  useT: () => ({
    pages: {
      profile: {
        ...
        apiKey: { title: 'API Key 管理', desc: '用于自动化调用', loadFail: '加载失败', denied: '当前角色无权管理 API Key', empty: '暂无密钥', name: '名称', key: 'Key 前缀', lastUsed: '最近使用', status: '状态', namePlaceholder: '输入密钥用途', create: '创建 Key', neverUsed: '从未使用', active: '启用', revoke: '撤销', securityTip: '安全提示' },
