...
describe('menu.def', () => {
  ...
  it('页面总数不变(87 页;+3 = procurement/install/install-board,+1 = apidocs,+1 = daily-close 柜台日结,+1 = onboarding 开户工作台)', () => {
    expect(MENU_GROUPS.flatMap((g) => g.items)).toHaveLength(87)
  })
