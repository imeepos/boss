...
FROM customers c WHERE c.phone = '13900001234'
ON CONFLICT DO NOTHING;
...
SELECT id, 'iptv', 'subscribe' FROM customers WHERE phone = '13900001234'
ON CONFLICT DO NOTHING;

INSERT INTO coupons (coupon_id, customer_id, name, amount, status, expire_at)
SELECT 'C-DEMO-001', id, '缴费满 100 减 20', 2000, 'active', now() + interval '90 days'
FROM customers WHERE phone = '13900001234'
