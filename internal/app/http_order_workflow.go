...
func registerOrderWorkflowRoutes(g *gin.RouterGroup, a *Application) {
	...
	wf.POST("/:orderNo/check-resource", func(c *gin.Context) {
		...
		a.recordAudit(c, "order.check_resource", "order", o.OrderNo, nil)
	...
	wf.POST("/:orderNo/reserve", func(c *gin.Context) {
		...
		a.recordAudit(c, "order.reserve", "order", o.OrderNo, gin.H{"portId": portID})
	...
	wf.POST("/:orderNo/charge", func(c *gin.Context) {
		...
		a.recordAudit(c, "order.charge", "order", o.OrderNo, nil)
	...
	tic.POST("/:ticketNo/activate", func(c *gin.Context) {
		...
		a.recordAudit(c, "order.activate", "dispatch_ticket", tk.TicketNo, nil)
