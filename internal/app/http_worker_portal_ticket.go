...
func myTickets(c *gin.Context, a *Application) ([]order.DispatchTicket, error) {
...
func registerWorkerPortalTicketRoutes(g *gin.RouterGroup, a *Application) {
...
func workerHomeHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		respond(c, apitypes.CodeOK, gin.H{
			"workerName": w.Name, "groupName": "", "phoneMasked": maskPhone(w.Phone),
...
func workerTicketsHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
		tickets, err := myTickets(c, a)
		if err != nil {
...
func workerTicketsHistoryHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
		tickets, err := myTickets(c, a)
		if err != nil {
...
func workerTicketDetailHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerHallHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		list, err := a.WorkOrder.ListDispatchTickets(c.Request.Context())
		if err != nil {
			respondErr(c, err)
...
func workerGrabHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
