...
func registerWorkerTicketActions(g *gin.RouterGroup, a *Application) {
...
func assignTicketToMe(c *gin.Context, a *Application, ticketNo string, grab bool) {
...
func workerTransferHandler(a *Application) gin.HandlerFunc {
...
func transferTicket(c *gin.Context, a *Application, tk *order.DispatchTicket, req *workerTransferReq) error {
	workerID, workerName := portalWorker(c)
	targetName := ""
...
func workerAuditOK(a *Application, action string) gin.HandlerFunc {
	return func(c *gin.Context) {
		a.recordAudit(c, "状态变更", "worker_ticket", c.Param("ticketNo"),
...
func workerRetryHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		tk, err := a.WorkOrder.GetDispatchTicketByNo(c.Request.Context(), c.Param("ticketNo"))
		if err != nil {
			respondErr(c, err)
...
func workerComplaintHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerRepairReportHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
