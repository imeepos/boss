...
func registerWorkerPortalMiscRoutes(g *gin.RouterGroup, a *Application) {
...
func workerMessagesHandler(a *Application) gin.HandlerFunc {
...
func workerNoticesHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerSafetyCheckHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		a.recordAudit(c, "数据变更", "worker_safety", req.WorkType,
