...
func registerWorkerPortalAssetRoutes(g *gin.RouterGroup, a *Application) {
...
func workerDismantleScanHandler(a *Application) gin.HandlerFunc {
...
func workerAssetReturnHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerMaterialsHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
...
func workerMaterialOutHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
...
func workerToolsHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
...
func workerToolBorrowHandler(a *Application, borrowed bool) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
...
func workerMaintenanceHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerResourcesHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
