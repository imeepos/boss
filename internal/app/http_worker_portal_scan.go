...
func registerWorkerPortalScanRoutes(g *gin.RouterGroup, a *Application) {
...
func workerScanBindHandler(a *Application) gin.HandlerFunc {
...
func portalQuadH(a *Application, c *gin.Context, addressID int64) gin.H {
...
func workerReportGetHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerReportSubmitHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerActivationGetHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		tk, ord, err := ticketOrder(c, a)
		if err != nil {
			respondErr(c, err)
...
func workerActivateHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		tk, _, err := ticketOrder(c, a)
		if err != nil {
			respondErr(c, err)
...
func workerChargePostHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		a.recordAudit(c, "数据变更", "worker_charge", c.Param("ticketNo"), map[string]any{
...
func ticketOrder(c *gin.Context, a *Application) (*order.DispatchTicket, *order.Order, error) {
	tk, err := a.WorkOrder.GetDispatchTicketByNo(c.Request.Context(), c.Param("ticketNo"))
	if err != nil {
		return nil, nil, err
	}
