...
var errGeoInvalidParam = errors.New("app: geo invalid param")
...
func registerGeoRoutes(g *gin.RouterGroup, a *Application) {
	...
	g.POST("/geo/countries", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.create-country", "geo_country", alpha2, nil)
	...
	g.PUT("/geo/countries/:code", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.update-country", "geo_country", c.Param("code"), nil)
	...
	g.PUT("/geo/countries/:code/active", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.set-country-active", "geo_country", c.Param("code"), map[string]any{"active": body.Active})
		respond(c, apitypes.CodeOK, nil)
	})
	...
	g.POST("/geo/countries/:code/names", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.add-country-name", "geo_country", c.Param("code"), nil)
		respond(c, apitypes.CodeOK, nil)
	})
	g.DELETE("/geo/countries/:code/names/:locale/:nameType", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.remove-country-name", "geo_country", c.Param("code"), nil)
		respond(c, apitypes.CodeOK, nil)
	})
	g.PUT("/geo/countries/:code/attrs", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.replace-country-attrs", "geo_country", c.Param("code"), nil)
		respond(c, apitypes.CodeOK, nil)
	})
	...
	g.POST("/geo/subdivisions", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.create-subdivision", "geo_subdivision", code, nil)
	...
	g.PUT("/geo/subdivisions/:code", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.update-subdivision", "geo_subdivision", c.Param("code"), nil)
		respond(c, apitypes.CodeOK, nil)
	})
	g.PUT("/geo/subdivisions/:code/active", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.set-subdivision-active", "geo_subdivision", c.Param("code"), map[string]any{"active": body.Active})
		respond(c, apitypes.CodeOK, nil)
	})
	g.POST("/geo/subdivisions/:code/names", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.add-subdivision-name", "geo_subdivision", c.Param("code"), nil)
		respond(c, apitypes.CodeOK, nil)
	})
	g.DELETE("/geo/subdivisions/:code/names/:locale/:nameType", perm, func(c *gin.Context) {
		...
		a.recordAudit(c, "geo.remove-subdivision-name", "geo_subdivision", c.Param("code"), nil)
		respond(c, apitypes.CodeOK, nil)
	})
}

// geoCreateCountry 新建国家(主键 alpha2 在 URL 外的 body 顶层)。
func geoCreateCountry(c *gin.Context, a *Application) (string, error) {
	var body struct {
...
func geoCreateSubdiv(c *gin.Context, a *Application) (string, error) {
	var body struct {
