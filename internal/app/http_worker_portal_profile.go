...
func registerWorkerPortalProfileRoutes(g *gin.RouterGroup, a *Application) {
...
func workerProfileHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		respond(c, apitypes.CodeOK, gin.H{
			...
			"phoneMasked": maskPhone(w.Phone), "online": true, "serveYears": 0,
...
func workerPerformanceHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
...
func workerScheduleHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
		month := c.Query("month")
		if month == "" {
...
func workerSettingsGetHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
...
func workerSettingsPutHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func workerFeedbacksHandler(a *Application) gin.HandlerFunc {
	return func(c *gin.Context) {
		workerID, _ := portalWorker(c)
