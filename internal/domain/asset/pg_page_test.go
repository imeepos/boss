...
func assetRows(mock pgxmock.PgxPoolIface, code string) *pgxmock.Rows {
	return mock.NewRows([]string{"id", "asset_code", "batch_id", "legal_entity_id", "legal_entity_name", "tag_id", "address_id", "region_id", "region_name", "type", "status", "model_id", "sn", "mac", "loid"}).
