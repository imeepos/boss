...
func TestAdjust_Mock(t *testing.T) {
	...
	mock.ExpectExec(`INSERT INTO loy_point_entries`).
		WithArgs(int64(7), int64(500), int64(500), ReasonAdjust, int64(0)).
...
func TestExchange_Mock(t *testing.T) {
	...
	mock.ExpectExec(`INSERT INTO loy_point_entries`).
		WithArgs(int64(7), int64(-300), int64(200), ReasonExchange, int64(5)).
		WillReturnResult(pgxmock.NewResult("INSERT", 1))
	mock.ExpectCommit()
...
func TestExchange_IssueFailCompensates(t *testing.T) {
	...
	mock.ExpectExec(`INSERT INTO loy_point_entries`).
		WithArgs(int64(7), int64(-300), int64(0), ReasonExchange, int64(5)).
		WillReturnResult(pgxmock.NewResult("INSERT", 1))
	mock.ExpectCommit()
	// 补偿回补事务
	mock.ExpectBegin()
	...
	mock.ExpectExec(`INSERT INTO loy_point_entries`).
		WithArgs(int64(7), int64(300), int64(300), ReasonReversal, int64(0)).
		WillReturnResult(pgxmock.NewResult("INSERT", 1))
	mock.ExpectCommit()
