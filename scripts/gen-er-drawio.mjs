...
const GROUPS = [
  ...
  ['师傅域', '#fff2cc', [
    ...
    ['worker_materials', '物料', 'FK worker_id/group_id', 'FK item_id→material_items(000091)'],
    ['worker_tools', '工具', 'FK worker_id/group_id', 'FK tool_id→material_tools(000091)'],
    ...
    ['worker_replace_logs', '换标签记录(000074)', 'FK worker_id', 'FK dispatch_ticket_id(000092)', 'FK old/new_tag_id(按EPC解析)'],
...
const EDGES = [
  ...
  ['worker_materials', 'material_items', 'N:1(000091)', 'fk'],
  ['worker_tools', 'material_tools', 'N:1(000091)', 'fk'],
  ['worker_attendance', 'workers', 'N:1', 'fk'], ['worker_safety_checks', 'workers', 'N:1', 'fk'],
  ['worker_replace_logs', 'workers', 'N:1', 'fk'],
  ['worker_replace_logs', 'dispatch_tickets', 'N:1(000092)', 'fk'],
  ['worker_replace_logs', 'tags', 'old/new EPC解析(000092)', 'fk'],
